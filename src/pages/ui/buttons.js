    ...
    return (
      <div>
        <Card title="基础按钮" className="card-wrap">
          <Button type="primary">Pipi</Button>
          <Button>Pipi</Button>
          <Button type="dashed">Pipi</Button>
          <Button type="danger">Pipi</Button>
          <Button disabled>Pipi</Button>
        </Card>
        ...
        <Card title="Loading按钮" className="card-wrap">
          ...
          <Button loading={this.state.loading} onClick={this.handleOpenLoading}>
            点击加载
          </Button>
          <Button
            shape="circle"
            loading={this.state.loading}
            onClick={this.handleOpenLoading}
          />
